...
public class PrometeoCarController : MonoBehaviour
{
    ...
    */
    ...
    public bool isCarAcceleratingNorDecelerating;
    ...
    */
    ...
    void Update()
    {
        ...
        */
        ...
        else
        {
            ...
            /*if ((!isCarAcceleratingNorDecelerating) && !isCarBraking && !deceleratingCar)
            {
                InvokeRepeating("DecelerateCar", 0f, 0.1f);
                deceleratingCar = true;
            }*/
    ...
    // Custom functions and modification of script
    public void GoForwardAndBackwards(Vector2 input)
    {
        if (input.y > 0.0f)
        {
            CancelInvoke("DecelerateCar");
            isCarAcceleratingNorDecelerating = true;
            deceleratingCar = false;
            GoForward();
        }
        ...
        {
            isCarAcceleratingNorDecelerating = false;
            ThrottleOff();
        }
    }

    public void TurningWheels(Vector2 input)
    {
        if (input.x < 0.0f)
        {
            TurnLeft();
        ...
        else if (input.x == 0.0f && steeringAxis != 0f)
        {
            ResetSteeringAngle();
        }
    }

    public void BrakingCar(float input)
    {
        if (input > 0.0f)
        {
            CancelInvoke("DecelerateCar");
